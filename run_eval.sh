...
# MODEL="CSEM3D_S"
# PATH_MODEL="monan/codigos_originais/CSEM3D_S"
# exec_aval

# MODEL="neural-fortran-main"
# PATH_MODEL="monan/codigos_originais/neural-fortran-main"
# exec_aval

# MODEL="tsunami-master"
# PATH_MODEL="monan/codigos_originais/tsunami-master"
# exec_aval

echo MODEL $MODEL
echo PATH_MODEL $PATH_MODEL

[ $MODEL != '' ] && [ $PATH_MODEL != '' ] && exec_aval
